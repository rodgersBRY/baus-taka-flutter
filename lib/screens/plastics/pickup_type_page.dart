import 'package:baus_taka/screens/plastics/plastics_summary_page.dart';
...
class PlasticPickupTypePage extends StatelessWidget {
  PlasticPickupTypePage({super.key});
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(color: AppColors.secondaryBlueColor),
                  ...
                  Expanded(
                    child: CustomBlueButton(
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => PlasticWasteSummaryPage()));
                      },
                      title: "Next Step",
                    ),
                  ),
